...
* **Hyper-Linked Textbook Glossary Tooltips:** Key statistical concepts throughout the simulation feature distinct visual indicators. Clicking any underlined term launches a floating definition card showing its precise description paired with explicit uppercase Excel formula keys.
